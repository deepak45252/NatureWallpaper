...
import com.devofindia.naturewallpaper.databinding.FragmentBoyBinding;
...
public class Boy_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentBoyBinding binding = FragmentBoyBinding.inflate(inflater, container, false);

        wallpaperModalList = new ArrayList<>();
        wallpaperAdapter = new WallpaperAdapter(wallpaperModalList, getContext());
        binding.rcboy.setAdapter(wallpaperAdapter);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 3);
        binding.rcboy.setLayoutManager(gridLayoutManager);
        ...
        binding.swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                binding.rcboy.addOnScrollListener(new RecyclerView.OnScrollListener() {
                    @Override
    ...
    private void fetchWallpaperApi() {
        StringRequest request = new StringRequest(Request.Method.GET, "https://api.pexels.com/v1/search/?page="+page_number+"&per_page=80&query=men",
