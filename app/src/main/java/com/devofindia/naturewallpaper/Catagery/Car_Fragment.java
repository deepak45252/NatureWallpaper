...
import com.devofindia.naturewallpaper.databinding.FragmentCarBinding;
...
public class Car_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.rccar.setAdapter(wallpaperAdapter);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 3);
        binding.rccar.setLayoutManager(gridLayoutManager);
        ...
        binding.swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                binding.rccar.addOnScrollListener(new RecyclerView.OnScrollListener() {
                    @Override
    ...
    private void fetchWallpaperApi() {
        StringRequest request = new StringRequest(Request.Method.GET, "https://api.pexels.com/v1/search/?page="+page_number+"&per_page=80&query=car",
